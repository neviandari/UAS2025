						...
						<form action="" method="post">
							<div class="modal-body">
								...
								<div class="form-group">
									...
									<input autocomplete="off" step="0.001" type="float" name="nilai" class="form-control" required>
								</div>
							</div>
										...
										<div class="modal-content">
											...
											<form action="list-sub-kriteria.php?id=<?php echo $d['id_sub_kriteria']; ?>" method="post">
												...
												<div class="modal-body">
													...
													<div class="form-group">
														<label class="font-weight-bold">Nilai</label>
														<input type="float" autocomplete="off" name="nilai" class="form-control" value="<?= $d['nilai'] ?>" required>
													</div>
												</div>
												<div class="modal-footer">
													<button type="button" class="btn btn-warning" data-dismiss="modal"><i class="fa fa-times"></i> Batal</button>
